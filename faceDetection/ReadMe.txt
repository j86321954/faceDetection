========================================================================
    主控台應用程式：faceDetection 專案概觀
========================================================================

AppWizard 已經為您建立了這個 faceDetection 應用程式。

這個檔案包含一份摘要，簡要說明構成 faceDetection 應用程式的
所有檔案，它們個別的內容。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 faceDetection.pch 的先行編譯標頭 (PCH) 檔，以及名為 StdAfx.obj 的先行編譯型別檔。
